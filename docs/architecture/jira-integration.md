...
- [System Design](system-design.md) — overall PH architecture and component layout
- [Central](central.md) — the backend that drives Jira sync
- [Lifecycle Phases](lifecycle-phases.md) — phase ordering and gate logic that trigger Jira updates
- [Skills](skills.md) — skill definitions including the orchestrator that calls gate tools
