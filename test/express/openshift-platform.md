# Test Prompt: Express — OpenShift Platform
...
- Just need MTV and OCP Virt operators installed and working
- A couple of pre-created VMs would be nice
- OCP 4.17
- Single demo, no multi-user needed
